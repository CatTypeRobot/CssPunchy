...
})({"e9fPE":[function(require,module,exports) {
"use strict";
...
const player = {
    ...
    n: 1,
    init: ()=>{
        player.ui.demo.innerText = (0, _cssJsDefault.default).substring(0, player.n);
        player.ui.demo2.innerHTML = (0, _cssJsDefault.default).substring(0, player.n);
        player.bindEvents();
        player.play();
    },
    bindEvents: ()=>{
    ...
    run: ()=>{
        player.n += 1;
        if (player.n > (0, _cssJsDefault.default).length) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"aZ75Z"}],"aZ75Z":[function(require,module,exports) {
...
},{}]},["e9fPE","gLLPy"], "gLLPy", "parcelRequire94c2")
